<%@ Page Language="C#" CodeFile="SubConDeliveryNote.aspx.cs" Inherits="SubConDeliveryNote" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table cellpadding="0" class="pageborder" cellspacing="0">
                ...
                <tr>
                    <td>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:Label ID="lblVendor" Text='<%# Eval("VendorCode")%>' runat="server"></asp:Label>
                                        </td>
                                    </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:SqlDataSource ID="dsRequisitionHeader" runat="server" ConnectionString="<%$ ConnectionStrings:PMSdbConnection %>"
                            SelectCommand="SELECT top 1 * FROM vSalesDeliveryNoteHeader WHERE (SupplyHID = @SupplyHID)">
                            <SelectParameters>
                ...
                <tr>
                    <td colspan="2">
                        Please recieve the undermentioned goods in good order and condition
                    </td>
                </tr>
                <tr>
                    <td>
                        <table border="1">
                            <asp:DataList ID="dlDeliveryNote" runat="server" DataSourceID="SqlDataSource1" CellPadding="4"
                                ...
                                SelectCommand="SELECT ROW_NUMBER()OVER(order by supplyHID) SRLNO,* from vSalesDeliveryDetails WHERE ([SupplyHID] = @SupplyHID)">
                                <SelectParameters>
                                    <asp:QueryStringParameter DefaultValue="1" Name="SupplyHID" QueryStringField="DlNo"
                                        Type="Decimal" />
                                </SelectParameters>
                ...
                <tr>
                    <td align="right">
                        <input id="btnPrint" class="ButtonStyle" type="button" onclick="window.print();"
                            value="Print" /></td>
                    </td>
                </tr>
            </table>
