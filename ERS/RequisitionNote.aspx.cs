...
public partial class ERS_RequisitionNote : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblReqNoteDate.Text = CommonFunctions.ConvertToAppDateFormat(DateTime.Now);
        lblReqNoteTime.Text = Convert.ToString(DateTime.Now.ToShortTimeString());
        lblNumber.Text = String.Format("{0:0000000}", Int32.Parse(Request.QueryString["RqNo"]));
